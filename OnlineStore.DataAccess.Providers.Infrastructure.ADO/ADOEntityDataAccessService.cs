...
using OnlineStore.DataAccess.Providers.Infrastructure.ADO.Exceptions;
...
public sealed class ADOEntityDataAccessService : IEntityDataAccessService
{
    ...
    public ADOEntityDataAccessService(string provider, string prefix, DbConnection dbConnection, DbCommand dbCommand)
    {
        ...
        ArgumentException.ThrowIfNullOrWhiteSpace(nameof(prefix));
        ...
        where TEntity : Entity
    {
        ...
        try
        {
            ...
            if (query.OutputParameter != null)
                outputDbParameter = _dbCommand.AddWithValue(query.OutputParameter.ValueName, query.OutputParameter.Size, query.OutputParameter.DbTypeOfValue, query.OutputParameter.ParameterDirection, _prefix);

            if (query.ReturnedValue != null)
                returnedDbParameter = _dbCommand.AddWithValue(query.ReturnedValue.ValueName, query.ReturnedValue.Size, query.ReturnedValue.DbTypeOfValue, query.ReturnedValue.ParameterDirection, _prefix);
